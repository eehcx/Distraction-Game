...
procedure TformNiveles7.btnGenerarClick(Sender: TObject);
begin
  Randomize;
  ruta:=ExtractFilePath(Application.ExeName);

  for i:=0 to 4 do
    ListCartas.Items.Add(IntToStr( Random(70) + 1 ));
...
procedure TformNiveles7.btnConfigClick(Sender: TObject);
begin
    formConfig.Show;
end;

procedure TformNiveles7.TimerTableroTimer(Sender: TObject);
begin
    P_Principal.Visible:=False;
    L_TextoInfo.Visible:=True;
end;

procedure TformNiveles7.btnAgregarClick(Sender: TObject);
begin
...
procedure TformNiveles7.btnComprobarClick(Sender: TObject);
begin
  memoComprobar.Clear;
  for i:=0 to ListCartas.Count-1 do
...
procedure TformNiveles7.TimerEditTimer(Sender: TObject);
begin
    E1.Visible:=True;
    E2.Visible:=True;
    E3.Visible:=True;
...
procedure TformNiveles7.TimerCerrarTimer(Sender: TObject);
begin
...
procedure TformNiveles7.AbrirPreguntaTimer(Sender: TObject);
begin
    formPregunta1.Show;
end;

procedure TformNiveles7.btnReiniciarClick(Sender: TObject);
begin
...
procedure TformNiveles7.btnReiniciarMouseMove(Sender: TObject;
...
procedure TformNiveles7.btnRegresarClick(Sender: TObject);
begin
    btnReiniciar.Enabled:=False;
    formNiveles7.Close;
end;

procedure TformNiveles7.btnRegresarMouseMove(Sender: TObject;
  Shift: TShiftState; X, Y: Integer);
begin
