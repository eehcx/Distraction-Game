...
procedure TformNivel1.btnGenerarClick(Sender: TObject);
begin
  Randomize;
  ruta:=ExtractFilePath(Application.ExeName);

  for i:=0 to 4 do
    ListCartas.Items.Add(IntToStr( Random(10) + 1 ));
...
procedure TformNivel1.btnConfigClick(Sender: TObject);
begin
    formConfig.Show;
end;

procedure TformNivel1.TimerTableroTimer(Sender: TObject);
begin
    P_Principal.Visible:=False;
    L_TextoInfo.Visible:=True;
end;

procedure TformNivel1.btnAgregarClick(Sender: TObject);
begin
...
procedure TformNivel1.btnComprobarClick(Sender: TObject);
begin
  memoComprobar.Clear;
  for i:=0 to ListCartas.Count-1 do
...
procedure TformNivel1.TimerEditTimer(Sender: TObject);
begin
    E1.Visible:=True;
    E2.Visible:=True;
    E3.Visible:=True;
...
procedure TformNivel1.TimerCerrarTimer(Sender: TObject);
begin
...
procedure TformNivel1.AbrirPreguntaTimer(Sender: TObject);
begin
    formPregunta1.Show;
end;

procedure TformNivel1.btnReiniciarClick(Sender: TObject);
begin
  ...
  {
  try try
    formL1 := TformLevel1.Create(Application);
    formL1.ShowModal;
  Except
...
procedure TformNivel1.btnReiniciarMouseMove(Sender: TObject;
...
procedure TformNivel1.btnRegresarClick(Sender: TObject);
begin
...
procedure TformNivel1.btnRegresarMouseMove(Sender: TObject;
  Shift: TShiftState; X, Y: Integer);
begin
...
procedure TformNivel1.TimerLosingTimer(Sender: TObject);
begin
