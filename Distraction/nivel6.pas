...
procedure TformNiveles6.btnGenerarClick(Sender: TObject);
begin
  Randomize;
  ruta:=ExtractFilePath(Application.ExeName);

  for i:=0 to 4 do
    ListCartas.Items.Add(IntToStr( Random(61) + 1 ));
...
procedure TformNiveles6.btnConfigClick(Sender: TObject);
begin
    formConfig.Show;
end;

procedure TformNiveles6.TimerTableroTimer(Sender: TObject);
begin
    P_Principal.Visible:=False;
    L_TextoInfo.Visible:=True;
end;

procedure TformNiveles6.btnAgregarClick(Sender: TObject);
begin
...
procedure TformNiveles6.btnComprobarClick(Sender: TObject);
begin
  memoComprobar.Clear;
  for i:=0 to ListCartas.Count-1 do
...
procedure TformNiveles6.TimerEditTimer(Sender: TObject);
begin
    E1.Visible:=True;
    E2.Visible:=True;
    E3.Visible:=True;
...
procedure TformNiveles6.TimerCerrarTimer(Sender: TObject);
begin
...
procedure TformNiveles6.AbrirPreguntaTimer(Sender: TObject);
begin
    formPregunta1.Show;
end;

procedure TformNiveles6.btnReiniciarClick(Sender: TObject);
begin
...
procedure TformNiveles6.btnReiniciarMouseMove(Sender: TObject;
...
procedure TformNiveles6.btnRegresarClick(Sender: TObject);
begin
...
procedure TformNiveles6.btnRegresarMouseMove(Sender: TObject;
  Shift: TShiftState; X, Y: Integer);
begin
