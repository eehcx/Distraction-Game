...
procedure TformNiveles5.btnGenerarClick(Sender: TObject);
begin
  Randomize;
  ruta:=ExtractFilePath(Application.ExeName);

  for i:=0 to 4 do
    ListCartas.Items.Add(IntToStr( Random(50) + 1 ));
...
procedure TformNiveles5.btnConfigClick(Sender: TObject);
begin
    formConfig.Show;
end;

procedure TformNiveles5.TimerTableroTimer(Sender: TObject);
begin
    P_Principal.Visible:=False;
    L_TextoInfo.Visible:=True;
end;

procedure TformNiveles5.btnAgregarClick(Sender: TObject);
begin
...
procedure TformNiveles5.btnComprobarClick(Sender: TObject);
begin
  memoComprobar.Clear;
  for i:=0 to ListCartas.Count-1 do
...
procedure TformNiveles5.TimerEditTimer(Sender: TObject);
begin
    E1.Visible:=True;
    E2.Visible:=True;
    E3.Visible:=True;
...
procedure TformNiveles5.TimerCerrarTimer(Sender: TObject);
begin
...
procedure TformNiveles5.AbrirPreguntaTimer(Sender: TObject);
begin
    formPregunta1.Show;
end;

procedure TformNiveles5.btnReiniciarClick(Sender: TObject);
begin
...
procedure TformNiveles5.btnReiniciarMouseMove(Sender: TObject;
...
procedure TformNiveles5.btnRegresarClick(Sender: TObject);
begin
...
procedure TformNiveles5.btnRegresarMouseMove(Sender: TObject;
  Shift: TShiftState; X, Y: Integer);
begin
