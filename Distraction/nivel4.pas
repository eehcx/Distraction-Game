...
var
  formNiveles4: TformNiveles4;
        ruta:String;
        i:Integer;
implementation

uses configuration, question1, nivel3;

{$R *.dfm}

procedure TformNiveles4.btnGenerarClick(Sender: TObject);
begin
  Randomize;
  ruta:=ExtractFilePath(Application.ExeName);

  for i:=0 to 4 do
    ListCartas.Items.Add(IntToStr( Random(35) + 1 ));
...
procedure TformNiveles4.btnConfigClick(Sender: TObject);
begin
    formConfig.Show;
end;

procedure TformNiveles4.TimerTableroTimer(Sender: TObject);
begin
    P_Principal.Visible:=False;
    L_TextoInfo.Visible:=True;
end;

procedure TformNiveles4.btnAgregarClick(Sender: TObject);
begin
...
procedure TformNiveles4.btnComprobarClick(Sender: TObject);
begin
  memoComprobar.Clear;
  for i:=0 to ListCartas.Count-1 do
...
procedure TformNiveles4.TimerEditTimer(Sender: TObject);
begin
    E1.Visible:=True;
    E2.Visible:=True;
    E3.Visible:=True;
...
procedure TformNiveles4.TimerCerrarTimer(Sender: TObject);
begin
...
procedure TformNiveles4.AbrirPreguntaTimer(Sender: TObject);
begin
    formPregunta1.Show;
end;

procedure TformNiveles4.btnReiniciarClick(Sender: TObject);
begin
...
procedure TformNiveles4.btnReiniciarMouseMove(Sender: TObject;
...
procedure TformNiveles4.btnRegresarClick(Sender: TObject);
begin
...
procedure TformNiveles4.btnRegresarMouseMove(Sender: TObject;
  Shift: TShiftState; X, Y: Integer);
begin
