...
uses
  ...
  Dialogs, ExtCtrls, MPlayer, StdCtrls, GraphicEx;

type
  TformNiveles2 = class(TForm)
    Logo: TImage;
    btnConfig: TImage;
    L_Nivel: TLabel;
    L_Ingrese: TLabel;
...
procedure TformNiveles2.btnGenerarClick(Sender: TObject);
begin
  Randomize;
  ruta:=ExtractFilePath(Application.ExeName);

  for i:=0 to 4 do
    ListCartas.Items.Add(IntToStr( Random(15) + 1 ));
...
procedure TformNiveles2.btnConfigClick(Sender: TObject);
begin
    formConfig.Show;
end;

procedure TformNiveles2.TimerTableroTimer(Sender: TObject);
begin
    P_Principal.Visible:=False;
    L_TextoInfo.Visible:=True;
end;

procedure TformNiveles2.btnAgregarClick(Sender: TObject);
begin
...
procedure TformNiveles2.btnComprobarClick(Sender: TObject);
begin
  memoComprobar.Clear;
  for i:=0 to ListCartas.Count-1 do
...
procedure TformNiveles2.TimerEditTimer(Sender: TObject);
begin
    E1.Visible:=True;
    E2.Visible:=True;
    E3.Visible:=True;
...
procedure TformNiveles2.TimerCerrarTimer(Sender: TObject);
begin
...
procedure TformNiveles2.AbrirPreguntaTimer(Sender: TObject);
begin
    formPregunta1.Show;
end;

procedure TformNiveles2.btnReiniciarClick(Sender: TObject);
begin
...
procedure TformNiveles2.btnReiniciarMouseMove(Sender: TObject;
...
procedure TformNiveles2.btnRegresarClick(Sender: TObject);
begin
...
procedure TformNiveles2.btnRegresarMouseMove(Sender: TObject;
  Shift: TShiftState; X, Y: Integer);
begin
